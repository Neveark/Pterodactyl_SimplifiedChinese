...
return [
    'index' => [
        'title' => '查看服务器 :name',
        'header' => '服务器控制台',
        'header_sub' => '在同时控制你的服务器.',
    ],
    'schedule' => [
        'header' => '计划任务管理',
        'header_sub' => '管理服务器所有的计划任务.',
        'current' => '当前的计划任务',
        'new' => [
            'header' => '创建新计划任务',
            'header_sub' => '为这个服务器创建一个新的计划任务.',
            'submit' => '创建计划任务',
        ],
        'manage' => [
            'header' => '管理计划任务',
        ...
        'toggle' => '切换状态',
        'run_now' => '触发计划任务',
        'schedule_created' => '成功为这个服务器创建了一个计划任务.',
        'schedule_updated' => '计划任务已经被更新.',
        'unnamed' => '未命名的计划任务',
    ...
    'config' => [
        'name' => [
            ...
            'details' => '服务器名称只是该面板上此服务器的显示，并不会影响可能会显示给游戏中的用户的任何特定于服务器的配置.',
        ],
        'startup' => [
